...
"							<hr>\n" +
"							<br>\n" +
"							<h4>Seleccione la foto de procuto que desee subir y apunte el nombre para asignarlo posteriormente:</h4>\n" +
"							<div class=\"span5\" id=\"form\">\n" +
"							<form method=POST enctype=\"multipart/form-data\" action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=gestorFotos\" >\n" +
"							<br>\n" +
"							<br>\n" +
