		...
		if (pass1.equals(pass2)) {
			...
			try {
				...
				Usuario modificado= GestorBD.getInstance().modificarDatosUsuario(conexion, user.getId(),
						nombre,pass1,pass2,email,dir,ciudad,provincia,cp,pais,tel);
	...
	private void formularioDatos(HttpServletRequest req, HttpServletResponse resp)throws IOException{
		...
		if (user!=null) {
			resp.getWriter().println(""
					...
					"							<br>\n" +
					"							<div class=\"span5\" id=\"form\">\n" +
					"							<form method=\"post\" action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=config\">\n" +
					"							<table id=\"datos\">\n" +
					...
					"							<tr><td colspan=\"2\">&nbsp;</td></tr>\n" +
					"							<tr><td>Provincia: </td><td><input type=\"text\" name=\"provincia\" value=\""+user.getProvincia()+"\"></td></tr>\n" +
					"							<tr><td colspan=\"2\">&nbsp;</td></tr>\n" +
