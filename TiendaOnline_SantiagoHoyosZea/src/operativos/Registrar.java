...
public class Registrar extends HttpServlet {
		...
		//fin de recuperación
				...
				if (pass1.equals(pass2)) {
					...
					try {
					    ...
					    st.execute("INSERT INTO `TIENDAONLINE`.`USUARIOS`(USER,PASSWORD,EMAIL,DIRECCION,CIUDAD,PROVINCIA,CP,PAIS,telefono,ULTIMA_CONEC,NIVEL_PRIVILEGIO)"+
						"VALUES ('"+nombre+"','"+pass1+"','"+email+"','"+dir+"','"+ciudad+"','"+provincia+"','"+cp+"','"+pais+"','"+tel+"','"+new SimpleDateFormat("YYYY-MM-dd").format(new Date())+"',"+"'cliente')");
							...
							response.getWriter().println(
									...
									"							<h2>¡Bienvenido a la Ubuntu Tienda!</h2>"+
									"							<br>\n" +
									"							<div class=\"span5\" id=\"form\">\n" +
									"							<form method=\"get\" action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp\">\n" +
									"							<input type=\"submit\" value=\"Ok, dejame comprar ya\">"+
									"							</form>\n" +
									"							<br>\n" +
									"							<br>\n" +
									"							</div>\n" +
					...
					response.getWriter().println(
							...
							"							<br>\n" +
							"							<div class=\"span5\" id=\"form\">\n" +
							"							<form method=\"get\" action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=config\">\n" +
	...
	private void formularioDatos(HttpServletRequest req, HttpServletResponse resp)throws IOException{
		...
		resp.getWriter().println(""
				...
				"							<br>\n" +
				"							<div class=\"span5\" id=\"form\">\n" +
				"							<form method=\"post\" action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=registrar\">\n" +
				"							<table id=\"datos\">\n" +
				...
				"							<tr><td colspan=\"2\">&nbsp;</td></tr>\n" +
				"							<tr><td>Provincia: </td><td><input type=\"text\" name=\"provincia\" required=\"true\"></td></tr>\n" +
				"							<tr><td colspan=\"2\">&nbsp;</td></tr>\n" +
