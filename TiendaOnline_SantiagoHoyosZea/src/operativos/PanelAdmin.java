...
public class PanelAdmin extends HttpServlet {
		...
		if (request.getSession().getAttribute("usuario")!=null && ((Usuario)request.getSession().getAttribute("usuario")).getPrivilegio().equals("admin")) {
			...
			if (seccion==null) {
				...
				response.getWriter().println(""
						...
						"							<center>\n" +
						"							<strong><a href=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=gestorProductos&hacer=add\">A&ntilde;adir producto</a>&nbsp;&nbsp;\n" +
						"							<a href=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=admin&seccion=productos&hacer=mod\">Modificar producto</a>&nbsp;&nbsp;\n" +
						"							<a href=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=admin&seccion=productos&hacer=del\">Eliminar producto&nbsp;&nbsp;</a>\n" +
						"							<a href=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=gestorFotos\" >Subir foto</a></strong>\n" +
						"							</center>\n" +
						"							<br>\n" +
						"							<br>\n" +
						"							</div>\n" +
	...
	private void imprimirTablaProdcutos(PrintWriter pintor, ArrayList<Producto> prodcutos,String accion){
		...
		pintor.println(""
				...
				"							<br>\n" +
				"							<div class=\"span5\" id=\"form\">\n" +
				"							<form action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp\" >\n" +
		...
		pintor.println(
				"	  						<tr>\n"+
				"   						<td class=\"tg-yw4l\" align=\"center\"><a href=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=gestorProductos&hacer="+accion+"&id="+producto.getId()+"\">"+producto.getId()+"</a></td>\n" +
				"    						<td class=\"tg-yw4l\" align=\"center\"><a href=\"/TiendaOnline_SantiagoHoyosZea/index.jsp?accion=gestorProductos&hacer="+accion+"&id="+producto.getId()+"\">"+producto.getNombre()+"</a></td>\n" +
