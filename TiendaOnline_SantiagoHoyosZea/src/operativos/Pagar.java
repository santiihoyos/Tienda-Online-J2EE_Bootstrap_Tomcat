...
public class Pagar extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getSession().getAttribute("usuario")!=null && ((Collection<Integer>)request.getSession().getAttribute("cantidades")).size()>0 ) {
			...
			"							<br>\n" +
			"							<div class=\"span5\" id=\"form\">\n" +
			"							<form method=\"post\" action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp\">\n" +
			"							<input type=\"hidden\" name=\"accion\" value=\"Pagar\">\n" +
			...
			"							<h4>Es posible que se le redidiriga a la web de Paypal</h4>\n" +
			"							<br>\n" +
			"							<div class=\"span5\" id=\"form\">\n" +
			"							<form method=\"post\" action=\"/TiendaOnline_SantiagoHoyosZea/index.jsp\">\n" +
			"							<input type=\"hidden\" name=\"accion\" value=\"Pagar\">\n" +
	...
	"							<tr><td colspan=\"2\">&nbsp;</td></tr>\n" +
	"							<tr><td>Provincia:</td><td align=\"center\"><strong>"+((Usuario)request.getSession().getAttribute("usuario")).getProvincia()+"</strong></td></tr>\n" +
	"							<tr><td colspan=\"2\">&nbsp;</td></tr>\n" +
