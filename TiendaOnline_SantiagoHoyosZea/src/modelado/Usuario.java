...
public class Usuario {
	...
	private int id;
	private String user,pass,email,calle,ciudad,provincia,cp,pais,telefono,privilegio;
	private Date ultima_conec;
	
	public Usuario(int id, String user, String pass, String email, String calle, String ciudad, String provincia,
